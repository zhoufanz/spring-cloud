...
import com.sunlight.storage.transfer.logic.depend.fallback.WarehouseServiceFallBack;
...
public interface WarehouseServiceClient {
    ...
    List<Map<String,String>> findWarehouseByUserId(@PathVariable("id") int id);
